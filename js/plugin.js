...
(function e$$0(x, z, l) {
    ...
    1: [function (A, x, z) {
        ...
        A = function () {
            ...
            function a(f, c) {
                var a = 1E6, b = 0, m = 1E6, d = 0, q = 1E6, n = 0, h, k, l;
            ...
            return {
                quantize: function (d, c) {
                    ...
                    var r = a(d, h), q = new g(function (a, b) {
        ...
        (function () {
            ...
            window.Vibrant = g = function () {
                ...
                b.prototype.findColorVariation = function (a, b, d, e, f, c) {
                    ...
                    p = this._swatches;
                    g = 0;
                    for (h = p.length; g < h; g++) if (k = p[g], s = k.getHsl()[1], m = k.getHsl()[2], s >= f && s <= c && m >= b && m <= d && !this.isAlreadySelected(k) && (m = this.createComparisonValue(s, e, m, a,
